...
public interface EmailLabelDao{
	 ...
	 * @throws Exception
	 */
	public List<EmailLabel> find(String columns, String condition, Object[] params, String orderBy) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<EmailLabel> findForPage(String columns,String condition, Object[] params,  int pageIndex, int pageSize, String orderBy) throws Exception;
