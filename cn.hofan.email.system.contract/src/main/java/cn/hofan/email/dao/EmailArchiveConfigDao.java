...
public interface EmailArchiveConfigDao{
	 ...
	 * @throws Exception
	 */
	public List<EmailArchiveConfig> find(String columns, String condition, Object[] params, String orderBy) throws Exception;
	 ...
	 * @throws Exception
	 */
	public List<EmailArchiveConfig> findForPage(String columns,String condition, Object[] params,  int pageIndex, int pageSize, String orderBy) throws Exception;
